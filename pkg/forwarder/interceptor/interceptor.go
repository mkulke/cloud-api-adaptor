...
func (i *interceptor) processOCISpec(spec *pb.Spec) {
	...
	// if the container has an annotation "io.confidentialcontainers.org.peerpod.attester",
	// then mount /run/confidential-containers/attester.sock to /run/confidential-containers/attester.sock
	// in the container
	if spec.Annotations["io.confidentialcontainers.org.peerpod.attester"] != "" {
